...
def main():
    ...
    if os.path.isfile("gene_name_to_embedding_gene_name.pkl"):
        gene_name_to_embedding = pickle.load(
            open("gene_name_to_embedding_gene_name.pkl", "rb")
        )
    else:
    ...
    try:
        ...
        pickle.dump(
            gene_name_to_embedding, open("gene_name_to_embedding_gene_name.pkl", "wb")
        )
        print(e)
        return
    pickle.dump(
